...
* Removes the restriction on new packages names for the APKs. NetherSX2 had to be installed over AetherSX2 - NetherSX2-Turnip lives alongside your existing NetherSX2/AetherSX2 and does not overwrite your existing AetherSX2/NetherSX2 installs
...
With this on my Retroid SD865 devices I can run taxing games like Sly 2 - Band of Thieves at 2x resolution without slowdown. Everything runs faster and therefore higher resolutions are not available to be used than with the stock Qualcomm drivers (or OpenGL)
